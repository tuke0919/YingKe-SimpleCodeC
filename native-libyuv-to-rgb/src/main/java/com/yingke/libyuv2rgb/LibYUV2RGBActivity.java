 ...
 *
 */
public class LibYUV2RGBActivity extends BaseActivity implements AssetsTask.Callback{
    ...
    public static void start(Context context){
        Intent intent = new Intent(context, LibYUV2RGBActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_native_libyuv2rgb);
        setupView();
    }
    ...
    public void onYUV420PToRGB24(View view) {
        ...
        LibYUV2RGB.yuv2rgb(path, LibYUV2RGB.Type.YUV420P_TO_RGB24, 510, 510, mSurfaceView.getHolder().getSurface());
    }

    public void onNV12ToRGB24(View view) {
        String path = mTvNV12.getText().toString();
        LibYUV2RGB.yuv2rgb(path, LibYUV2RGB.Type.NV12_TO_RGB24, 510, 510, mSurfaceView.getHolder().getSurface());
    }

    public void onNV21ToRGB24(View view) {
        String path = mTvNV21.getText().toString();
        LibYUV2RGB.yuv2rgb(path, LibYUV2RGB.Type.NV21_TO_RGB24, 510, 510, mSurfaceView.getHolder().getSurface());
    }
